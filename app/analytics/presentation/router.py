"""Analytics presentation — FastAPI router."""

from datetime import date, timedelta

from fastapi import APIRouter

from app.analytics.application.analytics_use_cases import (
    get_daily_summary,
    get_monthly_data,
    get_weekly_summary,
)
from app.analytics.presentation import DailySummary, MonthlyData, WeeklySummary
