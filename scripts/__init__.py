    ...
    for u in USERS:
        user = User(
            ...
            password_hash=bcrypt.hashpw(
                u["password"].encode(), bcrypt.gensalt()
            ).decode(),
